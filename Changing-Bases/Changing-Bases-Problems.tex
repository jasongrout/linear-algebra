...
\item DCT Project, involving changing coordinates to frequency domain, jumping to a nearby vector, and storing that nearby vector.  Decompression involves converting that nearby vector into the time domain and viewing the result.  Should cover 1-D DCT as well as 2d DCT and highlight the connections with JPEG and MPEG compression.  Highlight the connection to "basis functions" and coordinate vectors in 1d or 2d.
\end{enumerate}
