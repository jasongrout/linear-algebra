\input{Changing-Bases/Changing-Bases-Preparation}
...
We've studied this topic already when we studied inner products.  The integral $\int _{-1}^1 fg dx$ is called an inner product. Because the nonzero integrals are 1, we say that $S$ is an orthonormal basis.

\end{enumerate}

% \note{\item DCT Project, involving changing coordinates to frequency domain,
...
%   See
%   \url{http://www.faqs.org/faqs/compression-faq/part2/section-6.html},
%   \url{http://www.dip.ee.uct.ac.za/~nicolls/lectures/eee401f/projects/dct.pdf}, 

%   According to
%   \url{http://eeweb.poly.edu/~yao/EE3414/ImageCoding_DCT.pdf}, the DCT
%   is particularly useful if the image can be modeled by a markov
%   process (the next pixel depends only on the previous pixel).}
\end{enumerate}

\input{Changing-Bases/Changing-Bases-solutions}
