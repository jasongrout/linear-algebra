...
\input{Applications/Linear-Algebra-Applications-Preparation}
...
\centerline{\input{Applications/electric-circuit-2-loops}
...
\begin{enumerate}
	...
	\item Let $C$ be a matrix whose columns are the basis vectors obtained in part \ref{project2A}. Row reduce the transpose to obtain a different basis. 
	\item Let $D$ be a matrix whose columns are the basis vectors
          obtained in part \ref{project2B}. Row reduce the transpose to obtain a different basis.
