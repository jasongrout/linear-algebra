...
\frontmatter
\title{Linear Algebra}
\author{Ben Woodruff\\Minor edits by Jason Grout}
\date{Compiled \today}
\maketitle
...
\include{04-Linear-Transformations/Linear-Transformations-Content}
\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
\include{04-Linear-Transformations/Linear-Transformations-Problems}
\restoregeometry
\ifinstructor
\include{04-Linear-Transformations/Linear-Transformations-Instructor}
\fi


% \include{07-Inner-Products/Inner-Products-Content}
% \newgeometry{left=1in,right=1in,top=1in,bottom=1in}
% \include{07-Inner-Products/Inner-Products-Problems}
% \restoregeometry

% \include{05-Changing-Bases/Changing-Bases-Content}
% \newgeometry{left=1in,right=1in,top=1in,bottom=1in}
% \include{05-Changing-Bases/Changing-Bases-Problems}
% \restoregeometry


%\include{06-Jordan-Form/Jordan-Form}
%\newgeometry{left=1in,right=1in,top=1in,bottom=1in}
%\include{06-Jordan-Form/Jordan-Form-Problems}
%\restoregeometry
